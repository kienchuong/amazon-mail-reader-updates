...
class AmazonMailReaderApp(Tk):
    ...
    def _build_payments_tab(self) -> None:
        ...
        columns = ("date", "account", "email", "currency", "amount", "payment_id", "subject")
        ...
        widths = {"date": 150, "account": 120, "email": 200, "currency": 70, "amount": 110, "payment_id": 130, "subject": 360}
        for col in columns:
    ...
    def account_form_data(self) -> dict:
        return {
            ...
            "folder": self.acc_folder.g…858 tokens truncated…
...
if __name__ == "__main__":
    ...
    if storage is not None:
        selected_data_dir, selected_vault = storage
        app = AmazonMailReaderApp(selected_data_dir, selected_vault)
        app.mainloop()
