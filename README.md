...
Yêu cầu Python 3.12 trên Windows có Tkinter và thư viện trong `requirements.txt`. File `run_app.bat` ưu tiên Python đi kèm Codex, sau đó tự tìm Python đã cài trên Windows. Nếu thiếu CustomTkinter, file này tự cài thư viện trước khi mở app.
